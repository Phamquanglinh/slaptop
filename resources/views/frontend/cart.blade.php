...
@section('content')
    ...
    <div class="container">
        @for($i=1; $i<=3; $i++)
            <div class="row my-5 box-shadow">
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                    <img src="{{asset('asset/img/cart-page/laptop-lenovo.png')}}" class="img-fluid w-100">
                </div>
                <div class="col-12 col-sm-12 col-md-8 col-lg-8 p-4">
                    ...
                    <div class="input-group flex-wrap text-center">
                        <div class="input-group-prepend">
                            <button type="button" class="btn btn-outline-primary rounded-0 increment incPrice">
                                <i class="fas fa-plus"></i>
                            </button>
                        </div>
                        <input type="number" class="quantity counter_increment counter_decrement" value="1">
                        <div class="input-group-append">
                            <button type="button" class="btn btn-outline-primary rounded-0 decrement decPrice">
        ...
        @endfor
        <div class="row mb-5 box-shadow p-3">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 mb-3">
                <h3 class="mb-5">Chọn phương thức thanh toán</h3>
        ...
        <div class="row mb-5 box-shadow p-3 hidden">
